...
$RemainingSpace = $FileSystemMax - ( $FolderSizes | Where-Object { $_.Name -like '/' } ).Size
$RequiredSpace = $SpaceNeeded - $RemainingSpace

($FolderSizes | Where-Object { $_.Size -ge $RequiredSpace } | Sort-Object Size | Select-Object -First 1 ).Size